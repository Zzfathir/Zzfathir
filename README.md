...
<p><em>AI Student at <a href="https://www.um.edu.my/">UM</a><img src="https://media.giphy.com/media/fYSnHlufseco8Fh93Z/giphy.gif" width="30"></p>
...
const thir = {
  ...
  tools: [React, Node, Jquery, Styled-Components, Laravel, etc.],
}
```
